...
<div class="container mt-4 mb-4">
    <div class="row">
        ...
        <img src="{{asset('public/img/artigos/artigo2.jpg')}}" class="rounded mx-auto d-block" alt="A crise brasileira e a atuação do Estado sob o enfoque do Estado">
        ...
        <img src="{{asset('public/img/artigos/artigo2.jpg')}}" class="rounded mx-auto d-block" alt="O entrelace entre o Direito do Consumidor e os contratos de planos de saude">
